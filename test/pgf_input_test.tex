...
\usepackage{pgf-filehook}

\pgffilehook{Inputs,AtBegin={\testmessage{At Begin Of Inputs}},AtEnd={\testmessage{At End Of Inputs}}}

\pgfkeys{/filehook/InputFile/AtBegin={input}{\testmessage{At Begin Of Input File `input'}}}
